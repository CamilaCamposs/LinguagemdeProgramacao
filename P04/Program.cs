...
case "s":
resultado = num1 - num2;
break; // See https://aka.ms/new-console-template for more information
Console.WriteLine("Hello, World!");
case "m":
resultado = num1 * num2;
break;
case "d":// See https://aka.ms/new-console-template for more information
Console.WriteLine("Hello, World!");
break;
} // Fecha switch
return resultado;
} // Fecha Operacao } // Fecha Calculadora
}
class Programa
{
